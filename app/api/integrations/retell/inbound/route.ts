...
import { RetellToolError, getRetellDynamicVariables } from '@/lib/retell/tools'
...
export async function POST(request: Request) {
  ...
  try {
    ...
    const dynamicVariables = await getRetellDynamicVariables(callInbound.agent_id.trim(), technicalPhoneNumber)

  ...
  return (
    <form action={formAction} className="mt-8 space-y-5">
      <div>
        ...
        <input id="email" name="email" type="email" autoComplete="email" required className="w-full rounded-lg border border-zinc-300 bg-white px-3 py-2.5 text-zinc-950 placeholder:text-zinc-500 outline-none focus:border-zinc-900" />
      </div>
      <div>
        <label htmlFor="password" className="mb-2 block text-sm font-medium text-zinc-700">Contraseña</label>
        <input id="password" name="password" type="password" autoComplete="current-password" required className="w-full rounded-lg border border-zinc-300 bg-white px-3 py-2.5 text-zinc-950 placeholder:text-zinc-500 outline-none focus:border-zinc-900" />
      </div>

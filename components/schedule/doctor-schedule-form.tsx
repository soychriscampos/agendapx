...
export function DoctorScheduleForm({ doctorId, schedule, recurringUnavailability }: { doctorId: string; schedule: DoctorSchedule; recurringUnavailability: RecurringUnavailability[] }) {
  ...
  const [recurringOpen, setRecurringOpen] = useState(recurringUnavailability.length > 0)
